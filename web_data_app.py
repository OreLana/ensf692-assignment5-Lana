...
def book_data():
    ...
    sale_prices = [price - (price * 0.25) for price in prices]
...
@app.route("/learn")
def learn():
    return "One thing I learned in ENSF 692 is Data analysis using numpy and pandas."
